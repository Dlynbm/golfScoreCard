...
$(document).ready(function(){
    $("div[data-type='plugin']").html("<img id='close' src='Image/close.png'>");
...
function set(ht){
    $.ajax({
        ...
        success:function(data){
            ...
            $(ht).append("<img id='icon' src='Image/"+data.weather[0].icon+".png' width='30' height='30'>");
            var num =data.main.temp-272.15;
            var n = parseInt(num, 10);
            $(ht).append("<h5 id='temp' class='text'>"+n+"&deg;F</h5>");
